...
class Application(models.Model):
    ...
    user    = models.ForeignKey(UserProfile,related_name="applicantUser", on_delete=models.CASCADE) 
...
class ConversationMessages(models.Model):
    ...
    created_by  = models.ForeignKey(UserProfile, related_name="conversationmessages", on_delete=models.CASCADE)
...
class Notification(models.Model):
    ...
    created_by        = models.ForeignKey(UserProfile,related_name="creatednotifications", on_delete=models.CASCADE)
