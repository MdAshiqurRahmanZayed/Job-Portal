...
class UserProfile(models.Model):
    ...
    gender = models.CharField(
        blank=False, null=False, choices=GENDER_TYPE, max_length=1
    )
    marital_status = models.CharField(
        blank=False, null=False, max_length=20, choices=MARITAL_STATUS
    )
...
class Education(models.Model):
    ...
    user = models.OneToOneField(
        UserProfile, related_name="UserEducation", on_delete=models.CASCADE
    )
    ...
    ssc_certificate = models.FileField(
        upload_to="applicant/certificate/", max_length=100, null=True, blank=True
    )
    ...
    bsc_certificate = models.FileField(
        upload_to="applicant/certificate/", max_length=100, null=True, blank=True
    )
    ...
    msc_certificate = models.FileField(
        upload_to="applicant/certificate/", max_length=100, null=True, blank=True
    )
